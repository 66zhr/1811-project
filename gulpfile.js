...
//         // output:{//出口
//         //     filename:'index.js'//出口的名字
//         // }

//         //多入口 单出口   数组中谁在前面打包的时候也在前边
//         // entry: ['./src/views/index/javascripts/vendor.js','./src/views/index/javascripts/index.js'], //入口
//         // output:{//出口
//         //     filename:'index.js'//出口的名字
//         // }
...
//             index: './src/views/index/javascripts/index.js'}, //入口
//         output:{//出口
//             filename:'[name].min.js'//出口的名字 [name]代表在entry中键名是什么,打包出来的就是什么
//         }
//     }))
    ...
    for (const page in config.jsoptions) {
        ...
        let stream = gulp.src('src/entry.js')
            .pipe(webpack({
                ...
                entry:entry,//入口
                output:{filename:filename+'.min.js'},//出口名字
                module:{
